...
int main(int argc, char** argv)
{
    ...
    vpHomogeneousMatrix cdMu(vpTranslationVector(0, 0, -Zd), vpRotationMatrix(vpRzyxVector(0, 0, 0)));//vpRzyxVector(-1.5708, 0,  3.1416)
    cout<< "cdMu:\n" << cdMu << endl;
    // vpHomogeneousMatrix cdMo(cd_r_o);
    vpHomogeneousMatrix cdMc;
    cdMc = cdMu * (wMu.inverse() * wMc);
    vpFeatureThetaU tu(vpFeatureThetaU::cRcd);
    tu.buildFrom(cdMc);
    #pragma endregion thirdfeature
        ...
        plotter.setLegend(0, 9, "tu0");
        plotter.setLegend(0, 10, "tu1");
        plotter.setLegend(0, 11, "tu2");
